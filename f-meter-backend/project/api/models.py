...
class SubscriptionPlans(models.Model):
    ...
    grace_time = models.CharField(max_length=255,null=True,blank=True)
...
class Device(models.Model):
    ...
    user_token = models.CharField(max_length=500,null=True,blank=True)
    created_on = models.DateTimeField(auto_now_add=True,null=True, blank=True)
...
class SunglassShapes(models.Model):
    ...
    option1price = models.FloatField(default=0.0,null=True,blank=True)
    option1discountprice = models.FloatField(default=0.0,null=True,blank=True)
    option2 = models.ImageField(upload_to="singlass_options",null=True,blank=True, max_length=225)
    option2price = models.FloatField(default=0.0,null=True,blank=True)
    option2discountprice = models.FloatField(default=0.0,null=True,blank=True)
    option3 = models.ImageField(upload_to="singlass_options",null=True,blank=True, max_length=225)
    option3price = models.FloatField(default=0.0,null=True,blank=True)
    option3discountprice = models.FloatField(default=0.0,null=True,blank=True)
    option4 = models.ImageField(upload_to="singlass_options",null=True,blank=True, max_length=225)
    option4price = models.FloatField(default=0.0,null=True,blank=True)
    option4discountprice = models.FloatField(default=0.0,null=True,blank=True)
...
class SyncCode(models.Model):
    ...
    class Meta:
        db_table = "tbl_syc_code"

class Blink(models.Model):
    blinks = models.CharField(max_length = 255,null=True,blank=True)
    ear_values = models.CharField(max_length = 255,null=True,blank=True)
    user = models.ForeignKey(User,on_delete = models.CASCADE,null=True,blank=True)
    created_on = models.DateTimeField(auto_now_add = True)
    blink_status = models.BooleanField(default=False,null=True,blank=True)
