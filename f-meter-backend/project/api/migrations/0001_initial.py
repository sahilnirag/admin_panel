# Generated by Django 4.2.5 on 2024-01-12 10:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('random_code', models.CharField(blank=True, max_length=15, null=True)),
            ],
            options={
                'db_table': 'User_table',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('device_type', models.PositiveIntegerField(blank=True, choices=[(1, 'Mobile'), (2, 'Web')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grace_time', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option1price', models.FloatField(blank=True, default=0.0, null=True)),
                ('option1discountprice', models.FloatField(blank=True, default=0.0, null=True)),
                ('option2', models.ImageField(blank=True, max_length=225, null=True, upload_to='singlass_options')),
                ('option2price', models.FloatField(blank=True, default=0.0, null=True)),
                ('option2discountprice', models.FloatField(blank=True, default=0.0, null=True)),
                ('option3', models.ImageField(blank=True, max_length=225, null=True, upload_to='singlass_options')),
                ('option3price', models.FloatField(blank=True, default=0.0, null=True)),
                ('option3discountprice', models.FloatField(blank=True, default=0.0, null=True)),
                ('option4', models.ImageField(blank=True, max_length=225, null=True, upload_to='singlass_options')),
                ('option4price', models.FloatField(blank=True, default=0.0, null=True)),
                ('option4discountprice', models.FloatField(blank=True, default=0.0, null=True)),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('blinks', models.CharField(blank=True, max_length=255, null=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
