...
class UpdateClientProfile(APIView):
    ...
    def put(self,request, client_id, *args, **kwargs):
        ...
        if CompanyInformation.objects.filter(official_number = request.data.get('official_number')).exclude(id = request.data.get("id")):
        ...
        if CompanyInformation.objects.filter(company_name = request.data.get('company_name')).exclude(id = request.data.get("id")):
        ...
        if CompanyInformation.objects.filter(official_website = request.data.get('official_website')).exclude(id = request.data.get("id")):
