...
from .blink_rate_count import *
from .camera import CalculateDistance
from .blink_rate_count import CalculateBlinkCount
...
urlpatterns = [
    ...
    re_path(r'^generate-code/$', GenerateCode.as_view(), name="generate_code"),
    re_path(r'^expire-code/$', ExpireCode.as_view(), name="expire_code"),
    re_path(r'^match-code/$', MatchCode.as_view(), name="match_code"),
    re_path(r'^verify-token/$', VerifyToken.as_view(), name="verify-token"),
    re_path(r'^blinks-report-details/$', BlinksReportDetails.as_view(), name="blinks_report_details"),
    re_path(r'^create-report-details/$', CreateBlinksReport.as_view(), name="create_report_details"),

    re_path(r'^calculate-blink-rate/$', CalculateBlinkCount.as_view(), name="CalculateBlinkRate"),
